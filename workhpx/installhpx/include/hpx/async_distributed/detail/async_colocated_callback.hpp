...
#if defined(HPX_MSVC)
#pragma message("The header hpx/async_distributed/detail/async_colocated_callback.hpp is deprecated, " \
    "please include hpx/async_colocated/async_colocated_callback.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/async_distributed/detail/async_colocated_callback.hpp is deprecated, " \
    "please include hpx/async_colocated/async_colocated_callback.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
