...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/applier/register_apply_colocated.hpp is deprecated, " \
    "please include hpx/async_colocated/register_post_colocated.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/applier/register_apply_colocated.hpp is deprecated, " \
    "please include hpx/async_colocated/register_post_colocated.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
