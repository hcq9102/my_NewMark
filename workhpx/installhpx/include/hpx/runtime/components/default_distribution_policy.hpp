...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/components/default_distribution_policy.hpp is deprecated, " \
...
#else
#warning "The header hpx/runtime/components/default_distribution_policy.hpp is deprecated, " \
    "please include hpx/modules/runtime_components.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
