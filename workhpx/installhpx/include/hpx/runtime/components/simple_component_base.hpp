...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/components/simple_component_base.hpp is deprecated, " \
...
#else
#warning "The header hpx/runtime/components/simple_component_base.hpp is deprecated, " \
    "please include hpx/modules/components_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
