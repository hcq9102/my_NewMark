...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/components/server/destroy_component.hpp is deprecated, " \
    "please include hpx/async_colocated/server/destroy_component.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/components/server/destroy_component.hpp is deprecated, " \
    "please include hpx/async_colocated/server/destroy_component.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
