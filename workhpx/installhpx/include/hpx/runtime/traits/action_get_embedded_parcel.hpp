...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/traits/action_get_embedded_parcel.hpp is deprecated, " \
...
#else
#warning "The header hpx/runtime/traits/action_get_embedded_parcel.hpp is deprecated, " \
    "please include hpx/modules/parcelset_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
