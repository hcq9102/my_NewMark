...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/agas/server/component_namespace.hpp is deprecated, " \
    "please include hpx/modules/agas_base.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/agas/server/component_namespace.hpp is deprecated, " \
    "please include hpx/modules/agas_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
