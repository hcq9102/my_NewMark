...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/threads/policies/callback_notifier.hpp is deprecated, " \
...
#else
#warning "The header hpx/runtime/threads/policies/callback_notifier.hpp is deprecated, " \
    "please include hpx/modules/threading_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
