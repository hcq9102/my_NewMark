...
#if defined(HPX_MSVC)
#pragma message("The header hpx/runtime/actions/transfer_continuation_action.hpp is deprecated, " \
    "please include hpx/include/async.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/runtime/actions/transfer_continuation_action.hpp is deprecated, " \
    "please include hpx/include/async.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
