...
#if defined(HPX_MSVC)
#pragma message("The header hpx/parallel/executors/timed_execution_fwd.hpp is deprecated, " \
...
#else
#warning "The header hpx/parallel/executors/timed_execution_fwd.hpp is deprecated, " \
    "please include hpx/include/parallel_executors.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
