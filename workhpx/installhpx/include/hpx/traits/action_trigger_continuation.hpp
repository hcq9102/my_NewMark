...
#if defined(HPX_MSVC)
#pragma message("The header hpx/traits/action_trigger_continuation.hpp is deprecated, " \
    "please include hpx/modules/actions.hpp instead." \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0.")
#else
#warning "The header hpx/traits/action_trigger_continuation.hpp is deprecated, " \
    "please include hpx/modules/actions.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
