...
#if defined(HPX_MSVC)
#pragma message("The header hpx/traits/action_decorate_function.hpp is deprecated, " \
...
#else
#warning "The header hpx/traits/action_decorate_function.hpp is deprecated, " \
    "please include hpx/modules/components_base.hpp instead" \
    "To disable this warning, please define HPX_HAVE_DEPRECATION_WARNINGS=0."
#endif
#endif
